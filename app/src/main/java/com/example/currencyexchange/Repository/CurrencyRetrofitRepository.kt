...
class CurrencyRetrofitRepository constructor(private val apiServices: ApiServices) {
    ...
    fun fetchFluctuation(startDate: String, endDate:String, baseCurrency: String) = apiServices.getFluctuationData(startDate, endDate, baseCurrency, BuildConfig.API_KEY)
